...
当然，数字在承担主要工作。丹纳德缩放（Dennard Scaling）大约在 2006 年结束。摩尔定律（Moore's Law）大约在 2015 年结束。单线程性能增长率从 52%/年（1986–2003）降至 3%/年（2015 年至今）。这些原则所描述的每一个瓶颈，现在都成了该领域正在积极规避的问题。面向人工智能（AI）的硅片大量涌现，是该领域在收集这些原则一直指向的答案：把能量用在重要之处，把硅资源放到工作负载所在之处，不要与物理规律作对。
...
要达到最佳学习效果，你必须找到合适的心态。对我来说，这就是进入心流（flow state）。我通过将时间组织为一小时以上的专注时段，并在时段之间安排短暂休息，来稳定地进入这种心流状态。听有节奏且重复的节拍有助于把我的思维带入这种状态。
