...
最终公开验证：提交 `5413fa4` 触发的 GitHub Actions 工作流已成功完成，公开的芯片设计子路由已加载最新的中文稿与 39 个层级目录项。根地址、写作索引与各文章路由均采用静态 404 回退，以兼容 GitHub Pages 的项目子路径部署；最新版的目录、资源 URL 和语言切换在公开镜像中可正常使用。
